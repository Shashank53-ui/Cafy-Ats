...
export const SECTOR_PROTOTYPES: Record<AllowedSector, SectorPrototype> = {
  'Business & Strategy': {
    ...
    examples: [
      ...
      'Cloud Consultant',
      'Business Architect',
      'Business Architect and Org Design Lead',
      'Migration Architect',
      'Value Architect Managing Consultant',
      'ERP Architect Senior Consultant',
    ],
  },
  'Construction & Infrastructure': {
    base: 'Construction infrastructure built environment civil structural quantity surveying RIBA BIM highways ecology town planning. Site and landscape building design only.',
    examples: [
      'Quantity Surveyor',
      'Civil Engineer',
      'Structural Engineer',
  ...
  'Engineering (Hardware)': {
    ...
    examples: [
      ...
      'Electrical Design Architect, EMEA',
    ],
  },
  'Engineering (Other)': {
